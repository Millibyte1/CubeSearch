...
import io.github.millibyte1.array64.indices
import io.github.millibyte1.cubesearch.algorithm.heuristics.AbstractPatternDatabase
...
object PatternDatabaseUtils {
    ...
    fun getPopulation(table: ByteArray64): Long {
     ...
     * @param factory the cube factory to use
     */
    fun populateDatabaseIDDFS(table: ByteArray64, patternDB: AbstractPatternDatabase, factory: SmartCubeFactory = SmartCubeFactory()) {
    ...
    private fun databaseContains(cube: AnalyzableStandardCube, table: ByteArray64, patternDB: AbstractPatternDatabase): Boolean {
        return table[patternDB.getIndex(cube)] != (-1).toByte()
    }
    /** Adds the cost of this cube to the table */
    private fun addCost(cube: AnalyzableStandardCube, cost: Byte, table: ByteArray64, patternDB: AbstractPatternDatabase) {
        table[patternDB.getIndex(cube)] = cost
    }
    /** Adds this cost to the table */
    private fun addCost(index: Long, cost: Byte, table: ByteArray64) {
        table[index] = cost
    }
