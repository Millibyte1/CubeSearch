...
class IterativeDeepeningAStarSolver(costEvaluator: CostEvaluator, val usesBestFirstSearch: Boolean = true) : io.github.millibyte1.cubesearch.algorithm.AbstractSolver(costEvaluator) {
