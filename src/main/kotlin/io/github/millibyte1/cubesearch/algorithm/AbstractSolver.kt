...
import io.github.millibyte1.cubesearch.util.Path
 ...
 */
abstract class AbstractSolver(private val costEvaluator: CostEvaluator) : io.github.millibyte1.cubesearch.algorithm.Solver, CostEvaluator {
